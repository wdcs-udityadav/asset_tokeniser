...
contract AssetTokenizer {
    ...
    address constant USDT = 0xA02f6adc7926efeBBd59Fd43A84f4E0c0c91e832; //matic testnet
    ...
    event Invested(
        uint256 indexed propertyId,
        uint256 indexed amountInvested,
    ...
    function listProperty(
        ...
        require(_propertyId > 0 && _valuation > 0 && _investiblePercentage > 0 && _rentalIncome > 0, "Input must be greater than zero.");
    ...
    function claimDividend(uint256 _propertyId) public {
        ...
        uint256 dividendAmount = (listedProperties[_propertyId].rentalIncome * investments[_propertyId][msg.sender].percentageOfValuation)/100; 
